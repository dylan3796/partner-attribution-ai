...
### IP & Brand
- [ ] **Trademark search for "PartnerAI"** — Check USPTO TESS database. Risk: "Partner" is generic in this space, "AI" is descriptive. Consider:
  ...
  - **Backup names** if "PartnerAI" is contested: PartnerGraph, Attribly, PartnerIntel
...
- [ ] **Invoice generation** — Stripe handles this automatically:
  - Customize invoice template with PartnerAI branding
