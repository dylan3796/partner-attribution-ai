...
const demoResources: Resource[] = [
  ...
  { id: "r7", title: "Multi-Touch Attribution ROI", description: "Video case study on implementing role-based attribution and its impact on partner engagement.", category: "case_studies", type: "video", views: 534, downloads: 0, duration: "12 min", updatedAt: now - 6 * DAY, tags: ["attribution", "video"] },
  // Training
  ...
  { id: "r11", title: "API Integration Workshop", description: "Hands-on technical training for integrating partner program APIs into your existing workflows.", category: "training", type: "webinar", views: 189, downloads: 0, duration: "90 min", updatedAt: now - 18 * DAY, tags: ["api", "technical", "developer"] },
  // Marketing
  ...
  // Brand
  { id: "r18", title: "Brand Guidelines & Logo Pack", description: "Official logos (SVG, PNG), color palette, typography specs, and co-branding dos and don'ts.", category: "brand", type: "zip", views: 312, downloads: 178, fileSize: "18 MB", updatedAt: now - 30 * DAY, tags: ["logo", "brand", "guidelines"] },
];
