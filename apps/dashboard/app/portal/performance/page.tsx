...
export default function PerformancePage() {
  const { partner, myDeals, myAttributions, myPayouts } = usePortal();
  ...
  const metrics = useMemo(() => {
    ...
    const commScore = Math.min(
      20,
      totalCommissions > 0
        ? Math.min(20, Math.round(totalCommissions / 5000))
        : 0,
    );
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      <div>
        ...
        <p className="muted" style={{ marginTop: ".25rem" }}>
          Your personal stats and program standing
        </p>
      </div>
      ...
      >
          ...
          >
            ...
            <div>
              ...
              {metrics.nextTierName && metrics.pointsToNext > 0 && (
                <p
                  className="muted"
                  style={{ fontSize: ".78rem", marginTop: 6 }}
                >
                  {metrics.pointsToNext} points to{" "}
                  <span
                    style={{ textTransform: "capitalize", fontWeight: 600 }}
                  >
                    {metrics.nextTierName}
                  </span>
                </p>
              )}
            </div>
        ...
        <div className="card" style={{ padding: "1.5rem" }}>
          ...
          >
            <BarChart3 size={16} style={{ color: "#22c55e" }} /> Commission
            Trend (6 Months)
          </h3>
          {Object.values(metrics.monthlyComm).some((v) => v > 0) ? (
            ...
            <div style={{ padding: "2rem", textAlign: "center" }}>
              ...
              <p className="muted" style={{ fontSize: ".85rem" }}>
                No commission payouts yet. Close deals to start earning!
              </p>
            </div>
          )}
        </div>
      ...
      {/* Recent Deals */}
      <div className="card" style={{ padding: "1.5rem" }}>
        <h3 style={{ fontWeight: 700, fontSize: ".9rem", marginBottom: 12 }}>
        ...
        {myDeals.length > 0 ? (
          ...
          <div style={{ padding: "2rem", textAlign: "center" }}>
            ...
            />
            <p className="muted" style={{ fontSize: ".85rem" }}>
              No deals yet. Register your first deal to track performance.
            </p>
          </div>
        )}
      </div>
