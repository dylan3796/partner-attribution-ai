...
const STEPS: OnboardingStep[] = [
  ...
  },
  {
    id: "tier",
    title: "Tier & Benefits",
    subtitle: "Understand your perks",
    icon: Trophy,
    color: "#eab308",
  },
  {
  ...
  },
  {
    id: "first-deal",
    title: "First Deal",
    subtitle: "Register an opportunity",
    icon: Briefcase,
    color: "#22c55e",
  },
  {
...
const TIER_BENEFITS = {
  bronze: {
    rate: "8%",
    dealReg: "Standard (48h)",
    mdf: "Not eligible",
    coSell: "Self-serve",
    training: "Basic library",
    support: "Community forum",
  },
  silver: {
    rate: "10%",
    dealReg: "Priority (24h)",
    mdf: "Up to $2,500/qtr",
    coSell: "Shared SE support",
    training: "Full library + webinars",
    support: "Email support",
  },
  gold: {
    rate: "12%",
    dealReg: "Priority (12h)",
    mdf: "Up to $10,000/qtr",
    coSell: "Dedicated SE",
    training: "Full + certification",
    support: "Priority email + Slack",
  },
  platinum: {
    rate: "15%",
    dealReg: "Instant approval",
    mdf: "Up to $25,000/qtr",
    coSell: "Dedicated team",
    training: "Full + executive briefings",
    support: "24/7 + named CSM",
  },
};
...
const RESOURCES = [
  {
    ...
    desc: "Step-by-step guide to your first 90 days",
    icon: FileText,
  ...
  },
  {
    ...
    desc: "Solutions, pricing, and positioning",
    icon: BarChart3,
  ...
  },
  {
    ...
    desc: "Pitch decks, case studies, and battle cards",
    icon: Target,
    href: "/portal/enablement",
    color: "#8b5cf6",
  },
  {
    title: "Training & Certs",
    desc: "Earn badges and boost your tier score",
    icon: BookOpen,
    href: "/portal/resources",
    color: "#f59e0b",
  },
  {
    title: "MDF Programs",
    desc: "Apply for marketing development funds",
    icon: Gift,
    href: "/portal/mdf",
    color: "#f43f5e",
  },
  {
    title: "Territory Map",
    desc: "See your assigned regions and accounts",
    icon: MapPin,
    href: "/portal/territory",
    color: "#06b6d4",
  },
];
...
function WelcomeStep({
  ...
  return (
    <div style={{ textAlign: "center", maxWidth: 600, margin: "0 auto" }}>
      ...
      <p
        className="muted"
        style={{ fontSize: "1.05rem", lineHeight: 1.6, marginBottom: "2rem" }}
      >
        You've joined a network of top-performing partners driving revenue
        together. Let's get you set up in just a few minutes.
      </p>
        ...
        {[
          {
            ...
            desc: "On every deal you influence",
            color: "#22c55e",
          },
          {
            icon: Shield,
            label: "Deal protection",
            desc: "Register & lock your deals",
            color: "#3b82f6",
          },
          {
            icon: Users,
            label: "Co-sell support",
            desc: "Our team helps you close",
            color: "#8b5cf6",
          },
        ].map((item) => (
          <div
          ...
          >
            ...
            <div
              style={{ fontWeight: 700, fontSize: ".9rem", marginBottom: 4 }}
            >
              {item.label}
            </div>
  ...
  const fields = [
    {
      ...
      label: "Company Name",
      icon: Building2,
      placeholder: partner?.companyName || "Your Company",
      prefill: partner?.companyName,
    },
    {
      key: "contactName",
      label: "Your Name",
  ...
  return (
    <div style={{ maxWidth: 560, margin: "0 auto" }}>
      ...
      <p className="muted" style={{ marginBottom: "1.5rem" }}>
        A complete profile helps us match you with the right opportunities and
        support.
      </p>
...
function TierStep({
  ...
  const TIER_COLORS: Record<
    string,
    { bg: string; fg: string; gradient: string }
  > = {
    bronze: {
      bg: "#cd7f3215",
      fg: "#cd7f32",
  ...
  return (
    <div style={{ maxWidth: 640, margin: "0 auto" }}>
      ...
      <p className="muted" style={{ marginBottom: "1.5rem" }}>
        ...
        <strong style={{ textTransform: "capitalize" }}>{tier}</strong> partner.
        Here's what you get — and how to level up.
      </p>
          ...
          {tiers.map((t, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: 4,
                background:
                  i <= currentIndex ? TIER_COLORS[t].fg : "var(--border)",
      ...
      {currentIndex < 3 && (
        ...
        >
          <Target
            size={18}
            style={{ color: TIER_COLORS[tiers[currentIndex + 1]].fg }}
          />
          <span style={{ fontSize: ".85rem" }}>
            <strong>Next tier:</strong> Close more deals and increase engagement
            to reach{" "}
            <strong style={{ textTransform: "capitalize" }}>
              {tiers[currentIndex + 1]}
            </strong>{" "}
            and unlock higher commissions.
          </span>
        </div>
      )}
...
function ResourcesStep({
  ...
  return (
    <div style={{ maxWidth: 640, margin: "0 auto" }}>
      ...
      <p className="muted" style={{ marginBottom: "1.5rem" }}>
        Everything you need to start selling — pitch decks, product info,
        training, and more.
      </p>
      ...
      >
        {RESOURCES.map((r) => (
          ...
          >
            ...
            <div>
              <div
                style={{ fontWeight: 700, fontSize: ".9rem", marginBottom: 2 }}
              >
                {r.title}
              </div>
              <div className="muted" style={{ fontSize: ".8rem" }}>
...
function FirstDealStep({
  ...
  return (
    <div style={{ maxWidth: 560, margin: "0 auto" }}>
      ...
      <p className="muted" style={{ marginBottom: "1.5rem" }}>
        Deal registration protects your pipeline and ensures you get credit.
        Here's how it works:
      </p>
      ...
      >
        <h3
          style={{ fontWeight: 700, fontSize: "1rem", marginBottom: "1.25rem" }}
        >
          ...
          {[
            {
              ...
              desc: "Enter the company name, deal size, and your contact at the account.",
              color: "#3b82f6",
            },
            {
              step: 2,
              title: "We review & approve",
              desc: "Our team checks for conflicts and approves within your tier's SLA.",
              color: "#8b5cf6",
            },
            {
              step: 3,
              title: "You're protected",
              desc: "The deal is locked to you. No other partner can claim it.",
              color: "#22c55e",
            },
            {
              step: 4,
              title: "Close & earn",
              desc: "When the deal closes, your commission is calculated and paid automatically.",
              color: "#f59e0b",
            },
          ].map((s) => (
      ...
      >
        ...
        <h3 style={{ fontWeight: 700, marginBottom: 4 }}>
          Ready to register a deal?
        </h3>
        <p
          className="muted"
          style={{ fontSize: ".85rem", marginBottom: "1rem" }}
        >
          You can register your first deal now, or come back later from the
          Deals page.
        </p>
        <Link
          href="/portal/deals"
...
function DoneStep(_props: { partner: any }) {
  ...
  return (
    <div style={{ textAlign: "center", maxWidth: 560, margin: "0 auto" }}>
      ...
      <p
        ...
        style={{ fontSize: "1.05rem", lineHeight: 1.6, marginBottom: "2rem" }}
      >
        Your portal is ready. Start registering deals, track your commissions,
        and grow your partnership.
      </p>
            ...
            >
              ...
              >
                {isCompleted ? (
                  ...
                  <Icon
                    size={18}
                    style={{ color: isCurrent ? "#fff" : "var(--muted)" }}
                  />
                )}
              </div>
              <span
...
export default function PortalOnboardingPage() {
  ...
  return (
    ...
    >
      ...
      {currentStep === 2 && (
        <TierStep partner={partner} onNext={onNext} onBack={onBack} />
      )}
