      ...
      {data.map((d, i) => {
        ...
        return (
          ...
          >
            ...
            />
            <span className="muted" style={{ fontSize: ".6rem" }}>
              {d.label}
            </span>
          </div>
        );
...
function DonutChart({
  ...
  return (
    <div style={{ position: "relative", width: size, height: size }}>
      ...
      >
        <span style={{ fontSize: size * 0.18, fontWeight: 800 }}>
          {fmt(total)}
        </span>
        <span className="muted" style={{ fontSize: size * 0.1 }}>
          total
        </span>
      </div>
    </div>
...
export default function PortalCommissionsPage() {
  ...
  // unconditionally; none of them depend on `partner`.
    ...
    const cutoff =
      periodFilter === "30d"
        ...
        : periodFilter === "90d"
          ? now - 90 * DAY
          : now - 180 * DAY;
    return myAttributions.filter(
      (a) => (a.deal?.closedAt || a.deal?.createdAt || 0) > cutoff,
    );
  ...
  const pendingTotal = myPayouts
    .filter((p) => p.status !== "paid")
    .reduce((s, p) => s + p.commissionAmount, 0);
  const totalEarned = myAttributions.reduce(
  ...
  const last3MonthsTotal = monthlyData
    .slice(-3)
    .reduce((s, m) => s + m.value, 0);
  const projectedQuarterly =
    last3MonthsTotal > 0 ? last3MonthsTotal : totalEarned;
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      >
        <div>
          ...
          <p className="muted">
            Your earnings, payouts, and commission details
          </p>
        </div>
        <button
      ...
      >
        ...
        <div className="card" style={{ padding: "1.25rem" }}>
          ...
          >
            ...
            >
              <BarChart3 size={16} style={{ color: "#6366f1" }} /> Monthly
              Earnings
            </h3>
            <span
              className="muted"
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div className="muted" style={{ fontSize: ".75rem" }}>
                {hasMonthlyTrend
                  ? "Based on your last 3 months of earnings"
                  : "Based on total earnings to date"}
              </div>
            </div>
          </div>
          <span
            style={{ fontSize: "1.3rem", fontWeight: 800, color: "#6366f1" }}
          >
            {fmt(projectedQuarterly)}
          </span>
        </div>
      </div>
      ...
      <div className="card" style={{ padding: "1.25rem" }}>
        ...
        >
          ...
          <select
            ...
            style={{ maxWidth: 140, fontSize: ".8rem" }}
          >
            ...
            <div style={{ padding: "3rem 2rem", textAlign: "center" }}>
              ...
              <p className="muted" style={{ fontSize: ".85rem" }}>
                {periodFilter !== "all"
                  ...
                  : "When deals you influence close, your commissions will appear here automatically."}
              </p>
            </div>
          )}
        </div>
      ...
      <div className="card" style={{ padding: "1.25rem" }}>
        <h3
          style={{ fontWeight: 700, fontSize: ".95rem", marginBottom: "1rem" }}
        >
          Payout History
        </h3>
        {myPayouts.length === 0 ? (
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <div
                    style={{
                      ...
                      justifyContent: "center",
                      background:
                        p.status === "paid" ? "#22c55e15" : "#eab30815",
      ...
      <div
        className="card"
        style={{ padding: "1.25rem", background: "var(--subtle)" }}
      >
        <h3
          style={{
            fontWeight: 700,
          ...
          {[
            {
              step: "1",
              title: "Deal Closes",
              desc: "A deal you influenced is marked as won in the CRM.",
            },
            {
              step: "2",
              title: "Attribution Runs",
              desc: "Role-based model weights your touchpoints (referral, demo, co-sell).",
            },
            {
              step: "3",
              title: "Commission Calculated",
              desc: `Your ${commissionRate}% rate is applied to your attributed amount.`,
            },
            {
              step: "4",
              title: "Payout Processed",
              desc: "Approved commissions are paid within 5 business days.",
            },
          ].map((s) => (
            <div key={s.step} style={{ display: "flex", gap: 10 }}>
              ...
              <div>
                ...
                <div
                  className="muted"
                  style={{ fontSize: ".78rem", lineHeight: 1.4 }}
                >
                  {s.desc}
                </div>
              </div>
