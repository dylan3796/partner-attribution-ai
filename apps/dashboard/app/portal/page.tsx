  ...
  return (
    <div
      style={{
        ...
        borderRadius: 6,
        background:
          "linear-gradient(90deg, rgba(0,0,0,.04) 25%, rgba(0,0,0,.08) 50%, rgba(0,0,0,.04) 75%)",
...
export default function PortalDashboard() {
  ...
  const stats = useQuery(
    api.portalDashboard.getStats,
    partnerId ? { partnerId } : "skip",
  );
  const deals = useQuery(
    api.portalDashboard.getDeals,
    partnerId ? { partnerId } : "skip",
  );
  const touchpoints = useQuery(
    api.portalDashboard.getRecentTouchpoints,
    partnerId ? { partnerId, limit: 10 } : "skip",
  );
  ...
  const isLoading =
    stats === undefined || deals === undefined || touchpoints === undefined;
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: ".8rem", opacity: 0.85 }}>
                Set up your profile, learn about your benefits, and register
                your first deal
              </div>
            </div>
          </div>
        ...
        >
          <div style={{ flex: "1 1 300px" }}>
            ...
            {nextTier ? (
              <div>
                ...
                >
                  <strong style={{ color: "var(--fg)" }}>
                    {dealsToNextTier} more closed deal
                    {dealsToNextTier !== 1 ? "s" : ""}
                  </strong>{" "}
              ...
              <p
                style={{ fontSize: ".9rem", color: "#10b981", fontWeight: 600 }}
              >
          ...
          {touchpoints.length === 0 ? (
            <div style={{ padding: "3rem 1.5rem", textAlign: "center" }}>
              ...
              <p style={{ fontSize: ".85rem", color: "var(--muted)" }}>
                Touchpoints will appear here as you engage with deals
              </p>
            </div>
          ) : (
            touchpoints.map((tp) => (
                  ...
                  <p style={{ fontSize: "0.88rem" }}>
                    ...
                    {tp.dealName && tp.dealName !== "Unknown Deal" && (
                      <>
                        {" "}
                        on{" "}
                        <span style={{ fontWeight: 600 }}>{tp.dealName}</span>
                      </>
                    )}
                    {tp.dealAmount > 0 && (
                      <span
              ...
              {deals.slice(0, 6).map((deal) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`badge ${statusBadge[deal.status] ?? "badge-neutral"}`}
                      style={{
