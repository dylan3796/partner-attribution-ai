...
export default function LeaderboardPage() {
  ...
  const [sortBy, setSortBy] = useState<
    "composite" | "revenue" | "totalDeals" | "winRate" | "touchpoints"
  >("composite");
  ...
  const avgWinRate =
    rankings.length > 0
      ? Math.round(
          rankings.reduce((s, p) => s + p.winRate, 0) / rankings.length,
        )
      : 0;
  ...
  return (
    <>
      ...
      >
        <div>
          ...
          <p className="muted" style={{ marginTop: ".25rem" }}>
            Performance rankings across your partner program
          </p>
        </div>
        {/* Period toggle */}
        <div
          ...
          {rankings.slice(0, 3).map((p, i) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className="muted"
                  style={{ fontSize: ".75rem", marginBottom: ".75rem" }}
                >
                  {p.type} · {p.tier}
                </p>
                <div
              ...
              >
                ...
                <p
                  style={{
                    ...
                    fontWeight: 700,
                    fontSize: ".9rem",
                    color: p.revenue > 0 ? "#22c55e" : "var(--muted)",
                  }}
                >
                  {formatCurrencyCompact(p.revenue)}
                </p>
                ...
                >
                  <Zap
                    size={12}
                    color={p.touchpoints > 0 ? "#8b5cf6" : "var(--muted)"}
                  />
                  <span
                    style={{
                      fontWeight: 600,
      ...
      {sorted.length > 0 &&
        sorted.some(
          (p) => p.commissionsEarned > 0 || p.commissionsPending > 0,
        ) && (
          <div
            className="card"
                    ...
                    >
                      {p.commissionsEarned > 0 && (
                        <span style={{ color: "#22c55e", fontWeight: 700 }}>
                          {formatCurrencyCompact(p.commissionsEarned)} paid
                        </span>
                      )}
                      {p.commissionsPending > 0 && (
                        <span style={{ color: "#eab308", fontWeight: 600 }}>
                          {formatCurrencyCompact(p.commissionsPending)} pending
                        </span>
                      )}
                    </div>
                  </div>
