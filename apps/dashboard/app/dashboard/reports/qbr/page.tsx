    ...
    <div ref={reportRef} style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "1rem" }}>
        ...
        <div style={{ display: "flex", gap: ".75rem" }}>
          ...
          <Link href="/dashboard/reports/attribution" className="btn-outline" style={{ fontSize: ".8rem", padding: ".5rem 1rem" }}>
            ← All Reports
          </Link>
        </div>
      </div>
      ...
      <div style={{ borderTop: "1px solid var(--border)", paddingTop: "1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
        ...
        <div style={{ display: "flex", gap: ".75rem" }}>
          <Link href="/dashboard/reports/attribution" className="btn-outline" style={{ fontSize: ".8rem", padding: ".4rem 1rem" }}>
            Attribution Reports
          </Link>
