      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: 48 }}>
          ...
          <div style={{ display: 'flex', position: 'relative', width: 40, height: 26, marginRight: 12 }}>
            <div style={{ position: 'absolute', left: 0, top: 2, width: 22, height: 22, borderRadius: 22, border: '3px solid #2563eb' }} />
            <div style={{ position: 'absolute', left: 12, top: 2, width: 22, height: 22, borderRadius: 22, border: '3px solid #2563eb' }} />
          </div>
