...
function MockDealRow({ name, amount, status, product }: { name: string; amount: string; status: string; product: string }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 0", borderBottom: "1px solid rgba(255,255,255,.06)" }}>
      <div>
        <p style={{ fontSize: ".85rem", color: "#fff", fontWeight: 500 }}>{name}</p>
        <p style={{ fontSize: ".7rem", color: "rgba(255,255,255,.35)" }}>{product}</p>
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        <span style={{ fontSize: ".85rem", color: "rgba(255,255,255,.7)", fontWeight: 500 }}>{amount}</span>
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "3rem 1.5rem" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: "5rem" }}>
        <p style={{ fontSize: ".75rem", fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", color: "rgba(129,140,248,.8)", marginBottom: ".75rem" }}>
          Partner Portal
        </p>
        ...
        <p style={{ fontSize: "1.15rem", color: "rgba(255,255,255,.55)", maxWidth: 640, margin: "0 auto 2rem", lineHeight: 1.7 }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <Link href="/contact" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "12px 24px", background: "rgba(255,255,255,.08)", color: "#fff", borderRadius: 8, fontWeight: 600, fontSize: ".9rem", textDecoration: "none", border: "1px solid rgba(255,255,255,.1)" }}>
            Talk to sales
          </Link>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: "5rem", textAlign: "center" }}>
        {[
          ...
          <div key={s.label} style={{ padding: "1.5rem 1rem", background: "rgba(255,255,255,.03)", borderRadius: 12, border: "1px solid rgba(255,255,255,.06)" }}>
            <p style={{ fontSize: "1.5rem", fontWeight: 800, color: "#fff", marginBottom: 4 }}>{s.stat}</p>
            <p style={{ fontSize: ".75rem", color: "rgba(255,255,255,.4)" }}>{s.label}</p>
          </div>
        ))}
      </div>
      ...
      <div style={{ marginBottom: "5rem" }}>
        ...
        >
          <PortalMockWindow title="portal.yourcompany.com">
            ...
            <p style={{ fontSize: ".7rem", color: "rgba(255,255,255,.3)", marginBottom: 8, textTransform: "uppercase", letterSpacing: ".05em" }}>Recent Activity</p>
        ...
        >
          <PortalMockWindow title="portal.yourcompany.com/deals/register">
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <div>
                <p style={{ fontSize: ".7rem", color: "rgba(255,255,255,.4)", marginBottom: 4 }}>Customer Company</p>
                <div style={{ padding: "8px 12px", background: "rgba(255,255,255,.06)", borderRadius: 6, border: "1px solid rgba(255,255,255,.08)", color: "#fff", fontSize: ".85rem" }}>Acme Corporation</div>
              </div>
              <div>
                <p style={{ fontSize: ".7rem", color: "rgba(255,255,255,.4)", marginBottom: 4 }}>Product</p>
                <div style={{ padding: "8px 12px", background: "rgba(255,255,255,.06)", borderRadius: 6, border: "1px solid rgba(255,255,255,.08)", color: "#fff", fontSize: ".85rem", display: "flex", justifyContent: "space-between" }}>
                  <span>Enterprise License</span>
                  <span style={{ color: "#22c55e", fontSize: ".75rem" }}>15% commission</span>
                </div>
              </div>
              <div>
                <p style={{ fontSize: ".7rem", color: "rgba(255,255,255,.4)", marginBottom: 4 }}>Estimated Deal Value</p>
                <div style={{ padding: "8px 12px", background: "rgba(255,255,255,.06)", borderRadius: 6, border: "1px solid rgba(255,255,255,.08)", color: "#fff", fontSize: ".85rem" }}>$85,000</div>
              </div>
              <div style={{ padding: "8px 14px", background: "rgba(129,140,248,.15)", borderRadius: 6, border: "1px solid rgba(129,140,248,.2)", fontSize: ".78rem", color: "rgba(129,140,248,.9)", display: "flex", alignItems: "center", gap: 6 }}>
      ...
      <div style={{ marginBottom: "5rem" }}>
        ...
        >
          <PortalMockWindow title="portal.yourcompany.com/commissions">
            ...
            <p style={{ fontSize: ".7rem", color: "rgba(255,255,255,.3)", marginBottom: 8, textTransform: "uppercase", letterSpacing: ".05em" }}>Recent Payouts</p>
            {[
              ...
              <div key={p.deal} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 0", borderBottom: "1px solid rgba(255,255,255,.06)" }}>
                <div>
                  <p style={{ fontSize: ".85rem", color: "#fff", fontWeight: 500 }}>{p.deal}</p>
                  <p style={{ fontSize: ".7rem", color: "rgba(255,255,255,.35)" }}>{p.rate} commission</p>
                </div>
                <div style={{ textAlign: "right" }}>
                  <p style={{ fontSize: ".85rem", color: p.status === "Paid" ? "#22c55e" : "#f59e0b", fontWeight: 600 }}>{p.amount}</p>
                  <p style={{ fontSize: ".65rem", color: "rgba(255,255,255,.35)" }}>{p.status}</p>
                </div>
              </div>
            ))}
          </PortalMockWindow>
          ...
          <PortalMockWindow title="portal.yourcompany.com/performance">
            <div style={{ marginBottom: 16 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                <div>
                  <p style={{ fontSize: ".85rem", fontWeight: 600, color: "#fff" }}>Gold Partner</p>
                  <p style={{ fontSize: ".7rem", color: "rgba(255,255,255,.4)" }}>72% to Platinum</p>
                </div>
            ...
            <p style={{ fontSize: ".7rem", color: "rgba(255,255,255,.3)", marginBottom: 8, textTransform: "uppercase", letterSpacing: ".05em" }}>6-month revenue trend</p>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: 4 }}>
              {["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"].map((m) => (
                <span key={m} style={{ fontSize: ".6rem", color: "rgba(255,255,255,.25)", flex: 1, textAlign: "center" }}>{m}</span>
              ))}
            </div>
          </PortalMockWindow>
        </SectionBlock>
          ...
          <PortalMockWindow title="portal.yourcompany.com/certifications">
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                { name: "Solution Selling", level: "Intermediate", status: "In Progress", color: "#818cf8", progress: 65 },
                { name: "Technical Integration", level: "Advanced", status: "Not Started", color: "rgba(255,255,255,.2)", progress: 0 },
                { name: "Enterprise Strategy", level: "Expert", status: "Locked", color: "rgba(255,255,255,.1)", progress: 0 },
              ].map((cert) => (
                <div key={cert.name} style={{ padding: "12px 14px", background: "rgba(255,255,255,.04)", borderRadius: 8, border: "1px solid rgba(255,255,255,.06)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                    <div>
                      <p style={{ fontSize: ".85rem", fontWeight: 600, color: cert.status === "Locked" ? "rgba(255,255,255,.3)" : "#fff" }}>{cert.name}</p>
                      <p style={{ fontSize: ".65rem", color: "rgba(255,255,255,.35)" }}>{cert.level}</p>
                    </div>
          ...
          <PortalMockWindow title="portal.yourcompany.com/announcements">
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                ...
                { type: "Product Update", title: "New API v3 Documentation Available", date: "5 days ago", color: "#818cf8", pinned: false },
                ...
                <div key={ann.title} style={{ padding: "12px 14px", background: ann.pinned ? "rgba(129,140,248,.06)" : "rgba(255,255,255,.03)", borderRadius: 8, border: `1px solid ${ann.pinned ? "rgba(129,140,248,.15)" : "rgba(255,255,255,.06)"}` }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                    {ann.pinned && <span style={{ fontSize: ".6rem", color: "#818cf8" }}>📌</span>}
                    ...
                    <span style={{ fontSize: ".6rem", color: "rgba(255,255,255,.25)", marginLeft: "auto" }}>{ann.date}</span>
                  </div>
                  <p style={{ fontSize: ".82rem", color: "rgba(255,255,255,.8)", fontWeight: 500 }}>{ann.title}</p>
                </div>
              ))}
            </div>
          </PortalMockWindow>
      ...
      <div style={{ marginBottom: "5rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <p style={{ color: "rgba(255,255,255,.45)", maxWidth: 560, margin: "0 auto", fontSize: ".95rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
          {[
            ...
            <div key={title} style={{ padding: "1.25rem", background: "rgba(255,255,255,.03)", borderRadius: 10, border: "1px solid rgba(255,255,255,.06)" }}>
              ...
              <p style={{ fontSize: ".78rem", color: "rgba(255,255,255,.4)", lineHeight: 1.5 }}>{desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ padding: "3rem", background: "rgba(129,140,248,.06)", borderRadius: 16, border: "1px solid rgba(129,140,248,.12)", marginBottom: "5rem", textAlign: "center" }}>
        <Shield size={32} style={{ color: "#818cf8", marginBottom: 12 }} />
        <h2 style={{ fontSize: "1.5rem", fontWeight: 700, marginBottom: ".75rem" }}>Fully white-labeled</h2>
        <p style={{ color: "rgba(255,255,255,.5)", maxWidth: 560, margin: "0 auto 1.5rem", lineHeight: 1.7, fontSize: ".95rem" }}>
        ...
        <div style={{ display: "flex", gap: 24, justifyContent: "center", flexWrap: "wrap" }}>
          {["Custom domain", "Your logo & colors", "Branded emails", "No 'Powered by' badges"].map((item) => (
            <span key={item} style={{ display: "flex", alignItems: "center", gap: 6, fontSize: ".85rem", color: "rgba(255,255,255,.6)" }}>
      ...
      <div style={{ textAlign: "center", padding: "4rem 0" }}>
        ...
        <p style={{ color: "rgba(255,255,255,.45)", maxWidth: 500, margin: "0 auto 2rem", fontSize: ".95rem", lineHeight: 1.7 }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <Link href="/demo" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 28px", background: "rgba(255,255,255,.08)", color: "#fff", borderRadius: 8, fontWeight: 600, fontSize: ".95rem", textDecoration: "none", border: "1px solid rgba(255,255,255,.1)" }}>
            Try the demo
          </Link>
        </div>
      </div>
