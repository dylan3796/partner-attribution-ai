...
const demoResources: Resource[] = [
  ...
  { id: "r7", title: "Acme Corp: Multi-Touch Attribution ROI", description: "Video case study on implementing role-based attribution and its impact on partner engagement.", category: "case_studies", type: "video", views: 534, downloads: 0, duration: "12 min", updatedAt: now - 6 * DAY, tags: ["attribution", "video"] },
  // Training
