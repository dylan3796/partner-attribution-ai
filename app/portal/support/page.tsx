  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem" }}>
        {[
          { icon: <MessageSquare size={20} />, label: "Channel Manager", value: "Your Partner Team", sub: "hello@covant.ai", color: "#6366f1" },
          { icon: <Mail size={20} />, label: "Support Email", value: "support@covant.ai", sub: "Avg response: 4h", color: "#22c55e" },
          { icon: <Phone size={20} />, label: "Priority Line", value: "Gold+ tier only", sub: "Contact support for details", color: "#f59e0b" },
