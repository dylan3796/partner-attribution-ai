...
const STEPS = [
  ...
  },
  {
    ...
    subtitle: "We'll load a demo org with 5 partners, 17 deals, commissions, and attribution data. Explore everything — nothing is locked.",
    icon: Zap,
    color: "#ec4899",
    features: [
      { icon: Users, text: "5 partners across Gold, Silver, and Bronze tiers" },
      { icon: Briefcase, text: "17 deals with full attribution audit trails" },
