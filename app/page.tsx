      ...
      <section className="hero" id="product">
        <div className="wrap">
          ...
          <p className="subtitle" style={{ maxWidth: 680, margin: "0 auto 2.5rem" }}>
            A partner platform that works the way you do.
          </p>
        ...
        <div className="wrap">
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "2.5rem", flexWrap: "wrap", marginBottom: "2.5rem" }}>
            {[
              ...
              { num: "24", label: "Blog Articles" },
              { num: "140+", label: "Shipped Items" },
            ].map(s => (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
            {[
              { date: "Mar 9", title: "Blog: Channel Sales Strategy", desc: "Comprehensive channel sales guide — the 24th SEO article targeting 'channel sales strategy' and 'indirect sales strategy.'" },
      ...
      <section style={{ padding: "5rem 0", background: "#000" }} id="pricing">
        <div className="wrap" style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: "1rem", color: "#666", maxWidth: 480, margin: "0 auto 2.5rem" }}>
            Start free. Add AI engines as you grow — Attribution, Incentives, Intelligence, CRM. No credit card required.
          </p>
