      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-500 max-w-2xl mx-auto mb-10 leading-relaxed">
            Track every touchpoint, calculate fair credit splits with 5 attribution models,
            and automate partner payouts — all powered by AI.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" onClick={handleDemoAccess}>
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">$480,000</p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-gray-500">Win Rate</p>
                  <p className="text-3xl font-bold text-emerald-600">71%</p>
                </div>
              </div>

              <div className="space-y-3">
                {[
                  { name: "Sarah Anderson", role: "Referral", pct: 40, amount: "$48,000" },
                  { name: "Marcus Johnson", role: "Integration", pct: 35, amount: "$42,000" },
                  { name: "Elena Rodriguez", role: "Content", pct: 25, amount: "$30,000" },
                ].map((p) => (
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">
              Attribution powers everything
            </h2>
            <p className="text-lg text-gray-500">
              Five models, one platform. Know exactly who deserves credit.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Equal Split, First Touch, Last Touch, Time Decay, and Role-Based — compare them side-by-side.",
              },
              {
                icon: Users,
                title: "Partner Management",
                desc: "Onboard partners, track performance, manage commissions — all in one place.",
              },
              {
                icon: Zap,
                title: "Real-Time Pipeline",
                desc: "Every touchpoint tracked automatically. Attribution calculated instantly when deals close.",
              },
            ].map((f) => (
              <div key={f.title} className="bg-white rounded-xl p-8 border border-gray-100">
                <div className="rounded-lg bg-indigo-50 p-3 w-fit mb-5">
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Ready to see your partner impact?
          </h2>
          <p className="text-lg text-gray-500 mb-8">
            Start with the live demo. No sign-up required.
          </p>
          <Button size="lg" onClick={handleDemoAccess}>
            Launch Demo Dashboard <ArrowRight className="h-5 w-5" />
          </Button>
        </div>
      </section>
