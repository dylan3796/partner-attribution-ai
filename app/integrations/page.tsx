...
const INTEGRATIONS: Integration[] = [
  {
    ...
    slug: 'salesforce',
    category: 'CRM',
    description: 'Import partner accounts and deals from Salesforce. Attribution data flows back so AEs see partner influence on every opportunity.',
    features: [
      'Import partners and deals via CSV or API',
      'Partner attribution fields on opportunities',
      'Outbound webhook to update Salesforce on deal approval',
      'Full two-way sync — coming soon',
    ],
    status: 'coming',
    tier: 'Pro',
    logo: '☁️',
  },
  {
    ...
    slug: 'hubspot',
    category: 'CRM',
    description: 'Import your HubSpot deals and contacts into Covant. Partner touchpoints tracked automatically as deals move through your pipeline.',
    features: [
      'Import deals and contacts via API',
      'Contact-to-partner mapping',
      'Touchpoint creation from HubSpot activity',
      'Full two-way sync — coming soon',
    ],
    status: 'coming',
    tier: 'Pro',
